...
const sendEmail = (e) => {
    ...
    if (contactName.value === '' || contactEmail.value === '' || Message.value === ''){
        ...
        //serviceID - templateID - #form - pubkickey
        emailjs.sendForm('service_i17la29','template_ayjfc3q','#contact-form','ShWpOa55ErPSwbvK4')
        .then(()=>{
            // show massage and color , window + dot to open emoji
